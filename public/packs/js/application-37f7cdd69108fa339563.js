...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var rails_ujs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rails-ujs */ "./node_modules/rails-ujs/lib/assets/compiled/rails-ujs.js");
...
rails_ujs__WEBPACK_IMPORTED_MODULE_0___default.a.start(); // Uncomment to copy all static images under ../images to the output folder and reference
...
$(document).on('turbolinks:load', function () {
  ...
  }); // $('.recrutement_edit').off("click").on("click", function(){
  //      var id = $(this).data('recrutementid')
  //      var club = $(this).data('id_recru')
  //      window.location.replace('/recrutements/'+id+'/edit?data_value='+club)
  // })
});
...
/******/ });
//# sourceMappingURL=application-37f7cdd69108fa339563.js.map